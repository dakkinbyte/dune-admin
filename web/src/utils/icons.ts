...
const ICON_BASE = (import.meta.env.VITE_ICON_BASE_URL as string | undefined)?.replace(/\/$/, '')

export function iconUrl(templateId: string): string | null {
  if (!ICON_BASE) return null
  return `${ICON_BASE}/${templateId}.webp`
}
